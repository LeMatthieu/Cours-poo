...
<?php
    ...
    ?>
<body class="bg-<?=$couleur?> <?=$textcolor?>">
<header> 
<nav class="navbar navbar-expand-lg navbar-dark bg-<?=$couleur?>">
  <a class="navbar-brand ms-5 <?=$textcolor?>" href="#">Bootstrap Color</a>
...
<div class="container-fluid mt-5 ms-5">
    ...
    <?=$texte?>
    <br>
    <a href="page2.php?data=UnePetiteCotelette?">Je suis carnivore</a>
    <br>
    <div class="row align-items-center">
    <div class="col">
    <button type="button" class="btn btn-<?=$couleur?> <?=$textcolor?> btn-lg ms-5 mt-5 ">Choisir un theme</button>
    </div>
    <div class="col-9 w-75">
        <p class="bg-<?=$couleur?> <?=$textcolor?>">theme choisi : <?=$couleur?> <?=$textcolor?></p>
    </div>
  </div>
